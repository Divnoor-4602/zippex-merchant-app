...
const BusinessDocumentsLayout = ({ children }: { children: React.ReactNode }) => {
      ...
      if (merchantData.isOnBoarded) {
        ...
        switch (merchantData.onboardingStep) {
          case 0:
            ...
            break;
          case 1:
            // If you want to keep the user on the current page, do nothing
            break;
          case 2:
            toast.warning(
              "Please finish your onboarding process to access your Dashboard!"
...
export default BusinessDocumentsLayout;